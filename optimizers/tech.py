            ...
            for i in range(function_num):
                ...
                if concurrent_function==0:
                    ...
                    if i not in new_function:
                        ...
                        new_function[i] = aco.ACO(parameters, self.server_pair, function_name, self.ci_avg, self.carbon_intensity[j], invoke_interval[i][j-self.window_size])
                        #a,_ = new_function[i].main(self.carbon_intensity[j],invoke_interval[i][j-self.window_size])
                        #decision, _ = new_function[i].main(self.carbon_intensity[j], invoke_interval[i][j-self.window_size])
                        decision, _ = new_function[i].main(self.carbon_intensity[j], invoke_interval[i][j-self.window_size])  # Adjust as needed
